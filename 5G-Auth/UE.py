...
print(Fore.RED+"------------------------------------------------------------")
print(Fore.RED+"  UE deliver")
print(Fore.GREEN+"[SUPI]%s\n" %(SUPI)+Fore.RED+"  to RAN")
...
print(Fore.CYAN+"------------------------------------------------------------")
print(Fore.CYAN+"  Get")
print(Fore.GREEN+"  [RAND]%s" %(RAND))
print(Fore.GREEN+"  [AUTN]%s" %(AUTN))
print(Fore.GREEN+"  [ngKSI]%s" %(ngKSI))
print(Fore.CYAN+"------------------------------------------------------------")
